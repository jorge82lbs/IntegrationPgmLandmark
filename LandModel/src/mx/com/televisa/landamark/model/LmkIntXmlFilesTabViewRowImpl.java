...
// ---------------------------------------------------------------------
public class LmkIntXmlFilesTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_LMKINTXMLFILESTAB = 0;
    ...
    public static final int NOMPATHFILE = AttributesEnum.NomPathFile.index();
     ...
     */
    public LmkIntXmlFilesTabViewRowImpl() {
    }

    /**
     * Gets LmkIntXmlFilesTab entity object.
     * @return the LmkIntXmlFilesTab
     */
    public EntityImpl getLmkIntXmlFilesTab() {
        return (EntityImpl) getEntity(ENTITY_LMKINTXMLFILESTAB);
    }
    ...
    /**
     * Gets the attribute value for NOM_PATH_FILE using the alias name NomPathFile.
     * @return the NOM_PATH_FILE
     */
    public String getNomPathFile() {
        return (String) getAttributeInternal(NOMPATHFILE);
    }

    /**
     * Sets <code>value</code> as attribute value for NOM_PATH_FILE using the alias name NomPathFile.
     * @param value value to set the NOM_PATH_FILE
     */
    public void setNomPathFile(String value) {
        setAttributeInternal(NOMPATHFILE, value);
    }
