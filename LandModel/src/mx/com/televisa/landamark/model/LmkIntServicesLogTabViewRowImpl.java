...
// ---------------------------------------------------------------------
public class LmkIntServicesLogTabViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_LMKINTSERVICESLOGTAB = 0;
    ...
    public static final int NUMPROCESSID = AttributesEnum.NumProcessId.index();
     ...
     */
    public LmkIntServicesLogTabViewRowImpl() {
    }

    /**
     * Gets LmkIntServicesLogTab entity object.
     * @return the LmkIntServicesLogTab
     */
    public EntityImpl getLmkIntServicesLogTab() {
        return (EntityImpl) getEntity(ENTITY_LMKINTSERVICESLOGTAB);
    }
    ...
    /**
     * Gets the attribute value for NUM_PROCESS_ID using the alias name NumProcessId.
     * @return the NUM_PROCESS_ID
     */
    public Integer getNumProcessId() {
        return (Integer) getAttributeInternal(NUMPROCESSID);
    }

    /**
     * Sets <code>value</code> as attribute value for NUM_PROCESS_ID using the alias name NumProcessId.
     * @param value value to set the NUM_PROCESS_ID
     */
    public void setNumProcessId(Integer value) {
        setAttributeInternal(NUMPROCESSID, value);
    }
